...
export function buildServer(opts: BuildOptions = {}): McpServer {
  ...
  server.registerTool(
    "maw_task",
    {
      title: "Company task board — add/ls/start/move/claim/assign/ask/mentions/comment/comments/resolve/review/hold/pr/done/note/epic/dep/block/unblock/archive",
      description:
      ...
      inputSchema: {
        action: z
          .enum(["add", "ls", "start", "move", "claim", "assign", "ask", "mentions", "comment", "comments", "resolve", "review", "hold", "pr", "done", "note", "epic", "dep", "block", "unblock", "archive"])
