  ...
  server.registerTool(
    "maw_task",
    {
      ...
      inputSchema: {
        ...
        state: z.enum(["backlog", "todo", "ready", "approve", "need-answer"]).optional().describe("add: start state (backlog|todo, default todo) · move: target lane (backlog|todo|ready parking; approve/need-answer = Tony's queues, reason REQUIRED)"),
