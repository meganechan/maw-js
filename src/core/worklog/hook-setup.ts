...
const HOOKS: HookSpec[] = [
  ...
  {
    // agent offload nudge (kobo-337) — PostToolUse(Agent): when a FOREGROUND sub-agent
    // blocked the pane past a threshold, remind the model to use run_in_background next
    // time (the offload guidance from kobo-317/320/321, software-enforced). duration_ms
    // is in the PostToolUse payload; bg calls self-exclude (flag + tiny detach duration).
    event: "PostToolUse",
    matcher: "Agent",
    file: "agent-offload-nudge.sh",
    b64: "",
  },
];
...
const STATUSLINE_B64 = "";
