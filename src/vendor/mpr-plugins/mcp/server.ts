...
export function buildServer(opts: BuildOptions = {}): McpServer {
  ...
  server.registerTool(
    "maw_task",
    {
      ...
      inputSchema: {
        action: z
          .enum(["add", "ls", "start", "move", "claim", "assign", "ask", "mentions", "comment", "comments", "review", "hold", "approve", "need-answer", "pr", "done", "note", "edit", "epic", "dep", "decompose", "block", "unblock", "archive"])
